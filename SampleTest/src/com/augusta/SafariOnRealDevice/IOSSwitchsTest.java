...
//			capabilities.setCapability("deviceName", "iPhone"); //
		...
		if(((WebElement) driver.findElements(By.className("UIASwitch")).get(0)).getAttribute("value").equals("1"));{
			((WebElement) driver.findElements(By.className("UIASwitch")).get(0)).click();
		}
//		if(((WebElement) driver.findElements(By.className("UIASwitch")).get(0)).getAttribute("Value").equals("0")){
//			((WebElement) driver.findElements(By.className("UIASwitch")).get(0)).click();
//		}
